...
type Props = { course: CourseLanding };
...
export default function MentoriaLandingPage({ course }: Props) {
    const checkoutUrl = course.kiwifyUrl ?? '#oferta';
    const realPrice = course.price ?? 29700; // fallback R$ 297,00
    const anchorPrice = 99700; // R$ 997,00 — âncora
    ...
    const modules = [
        {
            number: '01',
            title: 'A Preparação',
            subtitle: 'Quebrando os mitos. Recalibração metabólica.',
            items: [
                'Por que seu corpo foi programado para jejuar',
                'Os 3 inimigos metabólicos modernos',
                'O protocolo de transição suave (sem sofrimento)',
                'Exames e biomarcadores para monitorar sua evolução',
            ],
        },
        {
            number: '02',
            title: 'O Fogo Metabólico',
            subtitle: 'Cetose, autofagia e a reprogramação hormonal.',
            items: [
                'Jejum 16:8 — a base sólida',
                'Jejum 24h — o primeiro salto de adaptação',
                'Jejum 48h e 72h — território de elite (autofagia profunda)',
                'Como o GH dispara durante o jejum estendido',
            ],
        },
        {
            number: '03',
            title: 'O Domínio Mental',
            subtitle: 'Clareza predatória. Fome emocional aniquilada.',
            items: [
                'Por que a fome é psicológica após 48h',
                'O estado de "fluxo" que os homens ancestrais conheciam',
                'Silenciando o ruído mental com o protocolo de jejum seco matinal',
                'A voz que diz "para" — e por que você deve ignorá-la',
            ],
        },
        {
            number: 'BÔNUS',
            title: 'O Manual dos Órgãos',
            subtitle: 'Quebrando o jejum com poder.',
            items: [
                'As 5 refeições de quebra mais eficientes',
    ...
    const deliverables = [
        '4 semanas de acompanhamento direto',
        'Acesso ao grupo exclusivo da mentoria',
        'Protocolos em PDF para download',
        'Suporte via mensagem (resposta em 24h)',
        'Gravações de todas as sessões ao vivo',
        'O Manual dos Órgãos (BÔNUS)',
        ...
        <div className="min-h-screen bg-zinc-950 text-zinc-100 overflow-x-hidden">
            ...
            <section className="relative isolate overflow-hidden pt-16 pb-20 sm:pt-24 sm:pb-28">
                ...
                <div className="relative mx-auto max-w-4xl px-4 sm:px-6 text-center">
                    ...
                    {/* CTA hero */}
                    {course.waitlistEnabled && !course.kiwifyUrl ? (
                        <div className="mt-10 space-y-3">
                            <p className="text-sm text-zinc-400 font-medium">🔔 Próxima turma em breve — entre na lista:</p>
                        ...
                        <div className="mt-10 flex flex-col items-center gap-4">
                            <a
                                href="#oferta"
                                className="group inline-flex items-center gap-2.5 rounded-xl bg-amber-500 px-8 py-4 text-sm font-bold uppercase tracking-[0.12em] text-zinc-950 shadow-xl shadow-amber-500/20 transition-all hover:bg-amber-400 hover:shadow-amber-400/30 active:scale-[0.98]"
                            >
                    ...
                    <div className="mt-8 grid gap-8 text-zinc-400 sm:grid-cols-2">
                        <div className="space-y-5 text-[15px] leading-relaxed">
                            <p>
                                ...
                                <strong className="text-zinc-200">você precisa comer de 3 em 3 horas</strong> para
                                "manter o metabolismo acelerado". Isso não é ciência. É marketing de
                                ultraprocessados.
                            </p>
                            <p>
                                O resultado? Um corpo que <strong className="text-zinc-200">nunca descansa</strong>,
                                um sistema digestivo cronicamente inflamado e um cérebro dependente
                                de glicose que oscila entre picos e quedas brutais de energia.{' '}
                                <strong className="text-zinc-200">Névoa mental. Dependência de café. Irritabilidade.</strong>
                            </p>
                        </div>
                        <div className="space-y-5 text-[15px] leading-relaxed">
                            <p>
                                Nossos ancestrais caçavam, construíam impérios e tomavam decisões
                                críticas em estado de jejum. O jejum não é passar fome —{' '}
                                <strong className="text-zinc-200">
                                    é o estado natural de reparo, clareza e domínio do corpo masculino.
                                </strong>
                            </p>
                            <p>
                                A autofagia — o processo pelo qual suas células <em>comem</em> os
                                próprios detritos — só se ativa em jejum profundo. É a{' '}
                                <strong className="text-zinc-200">limpeza celular que nenhum suplemento consegue imitar.</strong>
                            </p>
                        </div>
                    </div>

                    {/* Sintomas — lista visual */}
            ...
            {/* ═══════════════════════════════════════════════════════════════
                BLOCO DE BENEFÍCIOS — Resumo visual
            ═══════════════════════════════════════════════════════════════ */}
                    ...
                    <div className="grid gap-5 sm:grid-cols-3">
                        {[
                            ...
                            },
                            {
                                ...
                                text: 'O estado de foco que seus ancestrais tinham durante a caça. Disponível para você em 2 semanas.',
                            },
                            {
                                icon: Zap,
                            ...
                            <div key={b.title} className="flex items-start gap-4 rounded-2xl border border-zinc-800 bg-zinc-900 p-5">
            ...
            <section id="oferta" className="relative border-t border-zinc-800/50 py-20 sm:py-28">
                ...
                >
                    <div className="h-[500px] w-[500px] rounded-full bg-amber-500/8 blur-3xl" />
                </div>
                ...
                <div className="relative mx-auto max-w-2xl px-4 sm:px-6 text-center">
                    ...
                    <h2 className="font-serif text-3xl font-bold text-white sm:text-4xl md:text-5xl mb-10">
                        Escolha entre pagar o preço agora<br className="hidden sm:block" />{' '}
                    ...
                    <div className="rounded-3xl border border-amber-500/25 bg-gradient-to-b from-zinc-900 to-zinc-900/60 p-8 sm:p-10 shadow-2xl shadow-amber-500/5">
                        ...
                        <div className="border-t border-zinc-800 pt-8">
                            ...
                            {course.waitlistEnabled && !course.kiwifyUrl ? (
                                ...
                                <a
                                    href={checkoutUrl}
                                    target={course.kiwifyUrl ? '_blank' : undefined}
                                    rel={course.kiwifyUrl ? 'noopener noreferrer' : undefined}
                                    className="mt-8 group flex w-full items-center justify-center gap-2.5 rounded-2xl bg-amber-500 px-8 py-5 text-sm font-black uppercase tracking-[0.12em] text-zinc-950 shadow-2xl shadow-amber-500/25 transition-all hover:bg-amber-400 hover:shadow-amber-400/35 active:scale-[0.98]"
                                >
                                    QUERO GARANTIR MINHA VAGA
                                    <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
                                </a>
                            ...
                            <div className="mt-6 flex items-center justify-center gap-3 rounded-xl border border-zinc-800 bg-zinc-900/50 px-5 py-3">
                                ...
                                <p className="text-xs text-zinc-400 text-left leading-relaxed">
                                    ...
                                    Se por qualquer motivo você não ficar satisfeito, devolvemos 100% do seu investimento. Sem perguntas.
                                </p>
                            </div>
                    ...
                    <div className="mt-12 space-y-4 text-left">
                        {[
                            ...
                            },
                            {
                                ...
                                a: 'Grupo exclusivo + sessões ao vivo + suporte direto via mensagem. Você terá acesso a mim durante as 4 semanas.',
                            },
                        ].map((faq) => (
