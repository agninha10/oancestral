...
export function RegisterForm({ callbackUrl, hasApple }: RegisterFormProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        startTransition(async () => {
            ...
            // 2 — Auto sign-in immediately after registration
        ...
        <div className="space-y-5">
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
                ...
                <div className="space-y-1.5">
                    <label htmlFor="reg-name" className="block text-xs font-semibold uppercase tracking-wider text-zinc-500">
                        Nome completo
                    </label>
                    <input
                        id="reg-name"
                ...
                <div className="space-y-1.5">
                    <label htmlFor="reg-email" className="block text-xs font-semibold uppercase tracking-wider text-zinc-500">
                        E-mail
                    </label>
                    <input
                        id="reg-email"
                ...
                <div className="space-y-1.5">
                    <label htmlFor="reg-password" className="block text-xs font-semibold uppercase tracking-wider text-zinc-500">
                        Senha
                    </label>
            ...
            <p className="text-center text-[11px] leading-relaxed text-zinc-700">
