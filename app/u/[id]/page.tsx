        ...
        <div className="min-h-screen bg-zinc-950 text-zinc-100">
            <div className="mx-auto max-w-2xl px-4 py-12 space-y-6">
                ...
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-8">
                                    ...
                                    {activeSocials.map(({ key, label, icon: Icon, color, prefix }) => {
                                        ...
                                        return (
                                            <a
                                                ...
                                                title={label}
                                                className={`flex items-center gap-1.5 text-sm text-zinc-500 transition-colors ${color}`}
                                            >
                    ...
                    {/* Stats */}
                    <div className="mt-6 grid grid-cols-1 gap-px border-t border-zinc-800 pt-6">
